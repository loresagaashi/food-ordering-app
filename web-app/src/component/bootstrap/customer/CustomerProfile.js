              ...
              <div className="card-body">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">{customer.firstName}</p>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">{customer.lastName}</p>
                  </div>
                </div>
                <hr />
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">{customer.password}</p>
                  </div>
                </div>
                <hr />
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">{customer.birthDate}</p>
                  </div>
                </div>
                <hr />
